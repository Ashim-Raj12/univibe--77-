...
export interface Profile {
  ...
  enrollment_status: 'current_student' | 'incoming_student' | 'passed_out' | 'parent' | 'exploring' | 'faculty' | null;
  is_verified: boolean;
...
export interface Notification {
    ...
    user_id: string;
    actor_id: string;
    type: 'new_follower' | 'new_comment' | 'new_like' | 'new_message' | 'verification_approved' | 'verification_rejected' | 'new_group_invite' | 'subscription_approved' | 'subscription_rejected' | 'subscription_pending' | 'parent_verification_approved' | 'parent_verification_rejected' | 'report_resolved' | 'voucher_request_completed' | 'voucher_request_rejected';
...
export interface VerificationSubmissionWithProfile extends VerificationSubmission {
    profiles: Profile;
    reviewer?: { id: string, name: string | null, avatar_url: string | null } | null;
}
...
export interface ParentVerificationSubmissionWithProfile extends ParentVerificationSubmission {
    profiles: Profile;
    reviewer?: { id: string, name: string | null, avatar_url: string | null } | null;
}
...
export type TransactionType = 'top_up' | 'task_payment' | 'task_reward' | 'p2p_transfer' | 'refund' | 'admin_adjustment' | 'redeem_voucher' | 'referral_bonus' | 'voucher_withdrawal';
...
export type CollabTaskType = 'collaboration' | 'tutoring' | 'notes' | 'project_help';
export type CollabStatusType = 'open' | 'in_progress' | 'completed' | 'cancelled' | 'disputed';
...
export interface VoucherWithdrawalRequestWithDetails extends VoucherWithdrawalRequest {
