...
const UniversityDetailsPage = lazy(() => import('./pages/UniversityDetailsPage')); // New Page
...
const ParentVerificationPage = lazy(() => import('./pages/ParentVerificationPage'));
...
const AdminSubscriptionReviewPage = lazy(() => import('./pages/admin/AdminSubscriptionReviewPage'));
const AdminParentVerificationPage = lazy(() => import('./pages/admin/AdminParentVerificationPage'));
const AdminTourApplicationsPage = lazy(() => import('./pages/admin/AdminTourApplicationsPage')); // New Admin Page
const AdminAppManagementPage = lazy(() => import('./pages/admin/AdminAppManagementPage')); // New Admin Page
const VibeCollabModerationPage = lazy(() => import('./pages/admin/VibeCollabModerationPage'));
const AdminVoucherManagementPage = lazy(() => import('./pages/admin/AdminVoucherManagementPage'));
const AdminVoucherRequestsPage = lazy(() => import('./pages/admin/AdminVoucherRequestsPage')); // New Admin Page
const AdminModeratorManagementPage = lazy(() => import('./pages/admin/AdminModeratorManagementPage')); // New Admin Page
const AdminEventRequestsPage = lazy(() => import('./pages/admin/AdminEventRequestsPage')); // New Admin Page
            ...
            <Suspense fallback={suspenseFallback}>
              <Routes>
                ...
                <Route element={<ProtectedRoute />}>
                  ...
                  <Route path="/edit-parent-profile" element={<ParentProfilePage />} />
                  ...
                  <Route path="/doubt-session/:id" element={<DoubtSessionPage />} />
                  ...
                  <Route path="/vibecollab/:id" element={<CollabPostDetailPage />} />
                  ...
                  <Route path="/verify-parent" element={<ParentVerificationPage />} />

                  <Route path="/admin" element={<AdminLayout />}>
                      <Route index element={<Navigate to="dashboard" replace />} />
                      <Route path="dashboard" element={<AdminDashboardPage />} />
                      <Route path="verification" element={<AdminVerificationPage />} />
                      <Route path="parent-verification" element={<AdminParentVerificationPage />} />
                      <Route path="tour-applications" element={<AdminTourApplicationsPage />} />
                      <Route path="users" element={<AdminUserManagementPage />} />
                      <Route path="communities" element={<AdminCommunityManagementPage />} />
                      <Route path="posts" element={<AdminPostManagementPage />} />
                      <Route path="vibecollab-moderation" element={<VibeCollabModerationPage />} />
                      <Route path="vouchers" element={<AdminVoucherManagementPage />} />
                      <Route path="voucher-requests" element={<AdminVoucherRequestsPage />} />
                      <Route path="colleges" element={<AdminCollegeManagementPage />} />
                      <Route path="moderators" element={<AdminModeratorManagementPage />} />
                      ...
                      <Route path="subscription-review" element={<AdminSubscriptionReviewPage />} />
                      <Route path="app-management" element={<AdminAppManagementPage />} />
