...
const HomePage: React.FC = () => {
        ...
        if (error) {
            ...
            if (isNewFilter) {
                ...
                setPosts(prev => {
                    ...
                    const newPosts = postsWithProfiles.filter((p: PostWithProfile) => !existingIds.has(p.id));
    ...
    useEffect(() => {
        const handleRealtimeChange = () => {
            ...
            // This is simpler and more robust than handling individual insert/update events.
            fetchPosts(true);
        };
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="hidden md:block bg-card rounded-2xl shadow-soft border border-border">
                        <PostForm onNewPost={() => {
                            ...
                            // The realtime listener will also catch this, but this provides a faster user experience.
