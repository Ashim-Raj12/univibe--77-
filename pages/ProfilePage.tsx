...
export const getRoleFromProfile = (profile: Profile | null): UserRole => {
  ...
  if (
    ["current_student", "incoming_student", "passed_out", "exploring"].includes(
      status
    )
  ) {
    return "student";
              ...
              <span
                className={`inline-block mt-2 px-3 py-1 text-xs font-semibold rounded-full ${
                  profile.enrollment_status === "current_student"
                    ...
                    : profile.enrollment_status === "incoming_student" ||
              ...
              >
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p>
                      Unlock exclusive features like Study Hub & Campus Tours.
                    </p>
                  </div>
